...
slide(8,'第一輪：驗證一個功能','選擇測試環境的「查詢或修改案件」，走完一輪即可。',[['01 · 觀察與描述','找到 API 請求，列出身分、資源、允許操作與 CIA 影響。'],['02 · 改變條件','用未登入、不同權限與不同資源歸屬的測試帳號送出請求。'],['03 · 留下證據','確認拒絕且沒有資料副作用；把結果寫進測試與規格，整理未驗證的範圍。']], '完成後標記本頁，回到地圖選下一個要補齊的概念。')
];
